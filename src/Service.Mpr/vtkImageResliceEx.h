...
#ifndef vtkImageReslice_hEX
#define vtkImageReslice_hEX

#include <limits>

#include "vtk-9.0/vtkImagingCoreModule.h" // For export macro
#include "vtk-9.0/vtkThreadedImageAlgorithm.h"
...
class VTKIMAGINGCORE_EXPORT vtkImageResliceEx : public vtkThreadedImageAlgorithm
{
public:
	static vtkImageResliceEx* New();
	vtkTypeMacro(vtkImageResliceEx, vtkThreadedImageAlgorithm);
...
private:
	vtkImageResliceEx(const vtkImageResliceEx&) = delete;
	void operator=(const vtkImageResliceEx&) = delete;

public:
	bool m_sliceTopLeftPositionSet;
	bool m_sliceTopRightPositionSet;
	bool m_sliceBottomLeftPositionSet;
	
	double m_sliceTopLeftPositon[3];
	double m_sliceTopRightPosition[3];
	double m_sliceBottomLeftPosition[3];
};
