...
#define CSTRING_TO_QSTRING(cstringText) QString::fromLocal8Bit(cstringText.GetString(), cstringText.GetLength())

#define TEXT_TO_QSTRING(strText, nLen) QString::fromLocal8Bit(strText, nLen)
